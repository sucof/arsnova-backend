...
public interface SessionService {
	...
	ScoreStatistics getLearningProgress(String sessionkey, String progressType, String questionVariant);

	ScoreStatistics getMyLearningProgress(String sessionkey, String progressType, String questionVariant);
